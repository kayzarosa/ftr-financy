...
import { transactionGridColumns } from "@/components/transaction/transactions-header";
import { TypeTransaction } from "@/components/transaction/type-transaction";
    ...
    <>
      ...
      >
        ...
        <span className="flex justify-end gap-2">
          <IconButton aria-label="Excluir transação" onClick={() => onDelete()}>
            <Trash className="size-4 text-danger" />
          </IconButton>

          <IconButton aria-label="Alterar transação" onClick={() => onUpdate()}>
